...
Επόμενο βήμα, βήμα σιδηρόδρομος, τα Animations. Βήμα εξερετικά απαραίτητο για κάθε παιχνίδι μιας και του δίνει ζωντάνια και χωρίς αυτό το παιχνίδι θα ήταν αχανές


Η εμπειρία μου μπυ έδειξε πως αν γίνει το παραμικρό λάθος σε οποιαδήποτε στάδιο του Blend Tree απλά όλα τα animation σχεδόν γίνονται προβληματικά ή μπερδεμένα.
