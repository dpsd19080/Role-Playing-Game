...
Πρώτη μου δουλειά (με βάση τις [οδηγίες](https://github.com/merkourisa/Role-Playing-Game/issues/2) ) ήταν να διορθώσω το γεγονός ότι ο Spider-Man πέρναγε πάνω από τα boxes στο περιβάλλον αντί να συγκρούεται με αυτά. Αυτό επιτυγχάνεται με την βοήθεια των Colliders.
